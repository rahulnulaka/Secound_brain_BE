...
const contentSchema = new mongoose_1.Schema({
    ...
    type: { type: String, enum: Object.values(TagsType_1.default), required: true },
...
const tagModel = (0, mongoose_1.model)("tags", tagSchema);
exports.tagModel = tagModel;
const linkModel = (0, mongoose_1.model)("links", linkSchema);
